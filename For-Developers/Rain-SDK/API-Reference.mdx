...
<CardGroup cols={2}>
  <Card icon="play" href="/quickstart" title="Quick Start">
    Learn how to initialize the SDK and fetch markets.
  </Card>
  <Card icon="gear" href="/configuration" title="Configuration">
    Review environment settings and available data sources.
  </Card>
</CardGroup>