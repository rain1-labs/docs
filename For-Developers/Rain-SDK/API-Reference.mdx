...
| Environment                     | Link                               |
| ------------------------------- | ---------------------------------- |
| Dev environment API swagger     | https://dev-api.rain.one/api-docs/ |
| Staging environment API swagger | https://stg-api.rain.one/api-docs/ |
| Prod environment API swagger    | https://api.rain.one/api-docs/     |
